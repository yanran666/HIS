package com.ygt.medicalCheck.domain;
...
/**
 * 病历记录对象 medical_records
 * 
 * @author ruoyi
 * @date 2024-07-17
 */
public class medicalCheck extends BaseEntity
{
    ...
    /** 挂号ID（外键参考挂号表） */
    @Excel(name = "挂号ID", readConverterExp = "外=键参考挂号表")
    private Long appointmentId;

    /** 医生ID（外键参考医生表） */
    @Excel(name = "医生ID", readConverterExp = "外=键参考医生表")
    private Long doctorId;

    /** 疾病ID（外键参考疾病表） */
    @Excel(name = "疾病ID", readConverterExp = "外=键参考疾病表")
