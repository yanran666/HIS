...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bg_0900_ai_ci COMMENT='医生表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `medical_records` (
  ...
  `doctor_id` int DEFAULT NULL COMMENT '医生ID',
  `clinic_date` date DEFAULT NULL COMMENT '就诊日期',
  `chief_complaint` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bg_0900_ai_ci COMMENT '主诉',
  `present_illness_history` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bg_0900_ai_ci COMMENT '现病史',
  `treatment_history` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bg_0900_ai_ci COMMENT '现病治疗情况',
  `past_history` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bg_0900_ai_ci COMMENT '既往史',
  `allergy_history` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bg_0900_ai_ci COMMENT '过敏史',
  `physical_examination` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bg_0900_ai_ci COMMENT '体格检查',
  `diagnosis` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bg_0900_ai_ci COMMENT '诊断描述',
  `notes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bg_0900_ai_ci COMMENT '备注',
...
) ENGINE=InnoDB AUTO_INCREMENT=141 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-07-06 08:47:00','',NULL,'超级管理员'),(2,'普通角色','common',2,'2',1,1,'0','0','admin','2024-07-06 08:47:00','',NULL,'普通角色');
...
INSERT INTO `sys_user` VALUES (1,103,'admin','预约医生','00','ry@163.com','15888888888','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2024-07-08 14:35:55','admin','2024-07-06 08:47:00','','2024-07-08 14:35:54','管理员'),(2,105,'diagnose','门诊医生','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2024-07-08 14:35:29','admin','2024-07-06 08:47:00','','2024-07-08 14:35:28','测试员');
...
-- Dump completed on 2024-07-08 14:37:16
